...
export function ProjectCard({
  ...
  return (
    <div className={`bg-[#262626] px-3 py-3 rounded-md`}>
      ...
      {isOdd ? (
        <div
          className={`flex flex-col  md:flex md:flex-row md:justify-between md:gap-3`}
        >
        ...
        <div
          className={`flex flex-col  md:flex md:flex-row-reverse md:justify-between md:gap-3`}
        >
          <div className="md:self-start self-center">images</div>
          <div className="md:max-w-[40%] text-justify flex flex-col gap-3 mt-3">
            {description.map((text) => (
